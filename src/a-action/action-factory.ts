...
export const createUpdate = (action:string, requestURL: string) => createAction(action, null, (id: number, params: any) => ({...params, id}), (id: number, params: any) => _http.post(requestURL, {...params, id}));
export const createUpdateStub = (action:string, requestURL: string) => createAction(action, null, (id: number, params: any) => ({...params, id}), (id: number, params: any) => _http.postStub(requestURL, {...params, id}));
